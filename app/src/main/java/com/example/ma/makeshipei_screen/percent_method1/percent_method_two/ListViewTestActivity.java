...
/**
 * 对于ListView必须将  item最外层的 高度设置为 固定值
 * 没有办法使用百分比 因为父控件是 ListView 不是 percent 系列容器
 * 该item内部的控件  可以使用Percent 系类属性
 */
public class ListViewTestActivity extends AppCompatActivity
{
    ...
    private List<String> mStr = Arrays.asList("Helloworld", "盗墓笔记", "秦时明月", "努力", "学习");
